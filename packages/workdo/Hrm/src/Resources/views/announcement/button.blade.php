@permission('announcement show')
    <div class="action-btn me-2">
        <a class="bg-warning btn btn-sm  align-items-center" data-url="{{ route('announcement.show', $announcements->id) }}"
            data-ajax-popup="true" data-size="md" data-bs-toggle="tooltip" title=""
            data-title="{{ __('Announcement Details') }}" data-bs-original-title="{{ __('View') }}">
...
@permission('announcement edit')
    <div class="action-btn me-2">
        <a class="mx-3 btn bg-info btn-sm  align-items-center"
            data-url="{{ route('announcement.edit', $announcements->id) }}" data-ajax-popup="true" data-size="md"
            data-bs-toggle="tooltip" title="" data-title="{{ __('Edit Announcement') }}"
