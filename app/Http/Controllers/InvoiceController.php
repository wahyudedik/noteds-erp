            ...
            if (!empty($restaurantOrder->product)) {
                ...
                foreach ($productData['products'] as $key => $value) {
                    ...
                    if($value['discountedPrice'] != 0){
                        $discount = $value['sales_price'] - $value['discountedPrice'];
                    }else{
                        $discount = 0;
                    }
                    $variantPrice = (float)($value['varient_price'] ?? 0) * (int)($value['quantity'] ?? 0);
                    ...
                    $transformedData[$count]['variant_price'] = $variantPrice;
                    $transformedData[$count]['discount'] = $discount;
                    ...
                    if ($acction == 'edit') {
                        ...
                        $transformedData[$count]['variantPrice'] = $invoice->items[$count]['variantPrice'];
                    }
                    $count++;
                }
            }
