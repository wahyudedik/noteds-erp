    ...
    <div class="p-3 border shadow-md rounded-lg">
        <div class="flex items-center justify-between">
            ...
            <div class="form-check">
                <input class="form-check-input payment_method input-checkbox" name="payment_method" id="paypal-payment"
                    type="radio" data-payment-action="{{ route('bookings.pay.with.paypal',[$slug]) }}">
            </div>
        </div>
    </div>
</div>
