...
<head>
    ...
    <title>@yield('page-title') |
        {{ !empty($admin_settings['title_text']) ? $admin_settings['title_text'] : config('app.name', 'WorkDo') }}
    </title>
    ...
    <link rel="icon"
        href="{{ !empty($admin_settings['favicon']) && check_file($admin_settings['favicon']) ? get_file($admin_settings['favicon']) : get_file('storage/logo/favicon.png') }}{{ '?' . time() }}"
        type="image/x-icon" />
    <!-- CSS Libraries -->
                ...
                <div class="auth-footer">
                    <div class="container">
                        <div class="row">
                            <div class="col-12">
                                <span>
                                    @if (!empty($admin_settings['footer_text']))
