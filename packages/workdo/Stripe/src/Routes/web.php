...
Route::middleware(['web'])->group(function ()
{
    ...
    Route::any('/water-park-pay-with-stripe/{slug?}', [StripeController::class,'WaterParkPayWithStripe'])->name('water.park.pay.with.stripe');
    ...
    //eBook
    Route::any('ebook/book-pay-with-stripe/{slug?}', [StripeController::class,'bookPayWithStripe'])->name('ebook.pay.with.stripe');
    Route::get('ebook/book-pay-with-stripe/{slug?}', [StripeController::class, 'getStripeBookPaymentStatus'])->name('ebook.stripe.status');

    // Yoga Classes Plan Routes
    Route::post('/yoga-courses-pay-with-stripe/{slug?}', [StripeController::class, 'YogaCoursesPayWithStripe'])->name('yoga.courses.pay.with.stripe');
    Route::get('/yoga-courses-plan/stripe/{slug?}', [StripeController::class, 'getYogaCoursesPaymentStatus'])->name('get.yoga.courses.pay.status');

    //Investment System
    Route::post('/invest-deposit-pay-with-stripe/{slug?}', [StripeController::class, 'InvestDepositPayWithStripe'])->name('invest.deposit.pay.payment.with.stripe');
    Route::get('/invest-deposit/stripe/{slug?}', [StripeController::class, 'getStripeInvestDepositPaymentStatus'])->name('invest.deposit.stripe.status');
});
