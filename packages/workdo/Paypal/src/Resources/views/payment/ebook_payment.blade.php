...
<label
    ...
    <input type="radio" name="payment_method" id="paypal-payment" class="form-radio text-primary payment_method" data-payment-action="{{ route('ebook.pay.with.paypal',[$slug]) }}" />
