...
<head>
    ...
    <meta property="og:image"
        content="{{ get_file(!empty($admin_settings['meta_image']) ? (check_file($admin_settings['meta_image']) ? $admin_settings['meta_image'] : 'storage/meta/meta_image.png') : 'storage/meta/meta_image.png') }}{{ '?' . time() }}">
    ...
    <!-- Favicon icon -->
    <link rel="icon"
        href="{{ check_file($favicon) ? get_file($favicon) : get_file('storage/logo/favicon.png') }}{{ '?' . time() }}"
        type="image/x-icon" />
