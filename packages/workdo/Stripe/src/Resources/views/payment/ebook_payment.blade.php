...
<label
    ...
    <input type="radio" name="payment_method" id="stripe-payment" class="form-radio text-primary payment_method" data-payment-action="{{ route('ebook.pay.with.stripe',[$slug]) }}" />
